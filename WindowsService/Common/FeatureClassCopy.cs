...
namespace WindowsService.Common
{
    ...
    public class FeatureClassCopy
    {
        ...
        {
            IWorkspace pWSSource = GetSDEWorkspace("172.16.1.108", "5151", "FHORCL", "fhorcl", "", "SDE.DEFAULT");
            IWorkspace2 pWStarget = (IWorkspace2)GetSDEWorkspace("172.16.1.24", "5151", "hr", "sys", "", "SDE.DEFAULT");
